//
//  NormalLineViewController.m
//  learnOpenGL
//
//  Created by you&me on 2019/5/7.
//  Copyright © 2019 you&me. All rights reserved.
//

#import "NormalLineViewController.h"
#import "AGLKVertexAttribArrayBuffer.h"
#import "sceneUtil.h"

@interface NormalLineViewController ()
...
@implementation NormalLineViewController{
...
- (void)viewDidLoad {
    ...
    if (true) {
        ...
        modelViewMatrix = GLKMatrix4Translate(modelViewMatrix, 0.0, .0f, .25f);
...
- (IBAction)takeShouldUseFaceNormalFrom:(UISwitch *)sender {
