...
-(void)renderNew{
    ...
    GLKMatrix4 projectionMatrix = GLKMatrix4MakePerspective(GLKMathDegreesToRadians(150.0), aspect, 0.5f, 200.f);
    ...
    dispatch_source_set_timer(self.timer, DISPATCH_TIME_NOW, delayInSeconds *NSEC_PER_SEC, 0.0);
